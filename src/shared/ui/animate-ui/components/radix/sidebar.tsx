  ...
  return (
    ...
    >
      ...
      <div
        ...
        className={cn(
          'duration-400 ease-sidebar relative w-[var(--sidebar-width)] bg-transparent transition-[width]',
      ...
      <div
        ...
        className={cn(
          'duration-400 ease-sidebar-container fixed inset-y-0 z-10 flex h-svh w-[var(--sidebar-width)] transition-[left,right,width]',
          side === 'left'
