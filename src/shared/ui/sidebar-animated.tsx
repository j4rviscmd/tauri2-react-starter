  ...
  return (
    ...
    >
      ...
      <div
        ...
        className={cn(
          'w-(--sidebar-width) duration-400 ease-[cubic-bezier(0.7,-0.15,0.25,1.15)] relative bg-transparent transition-[width]',
      ...
      <div
        ...
        className={cn(
          'w-(--sidebar-width) duration-400 ease-[cubic-bezier(0.75,0,0.25,1)] fixed inset-y-0 z-10 hidden h-svh transition-[left,right,width] md:flex',
          side === 'left'
...
function SidebarGroupLabel({
  ...
  return (
    <Comp
      ...
      className={cn(
        'outline-hidden flex h-8 shrink-0 items-center rounded-md px-2 text-xs font-medium text-sidebar-foreground/70 ring-sidebar-ring transition-[margin,opacity] duration-300 ease-linear focus-visible:ring-2 [&>svg]:size-4 [&>svg]:shrink-0',
...
function SidebarMenuAction({
  ...
  return (
    <Comp
      ...
      className={cn(
        // Increases the hit area of the button on mobile.
        'outline-hidden absolute right-1 top-1.5 z-[1] flex aspect-square w-5 items-center justify-center rounded-md p-0 text-sidebar-foreground ring-sidebar-ring transition-transform hover:bg-sidebar-accent hover:text-sidebar-accent-foreground focus-visible:ring-2 peer-hover/menu-button:text-sidebar-accent-foreground [&>svg]:size-4 [&>svg]:shrink-0',
        'after:absolute after:-inset-2 md:after:hidden',
