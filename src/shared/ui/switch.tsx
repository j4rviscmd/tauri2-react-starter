  ...
  return (
    ...
    >
      <motion.button
        data-slot="switch"
        className={cn(
          'relative flex h-6 w-10 shrink-0 cursor-pointer items-center rounded-full p-[3px] transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 focus-visible:ring-offset-background disabled:cursor-not-allowed disabled:opacity-50 data-[state=unchecked]:justify-start data-[state=checked]:justify-end data-[state=checked]:bg-primary data-[state=unchecked]:bg-input',
          className,
        )}
        whileTap="tap"
        initial={false}
      ...
      >
        {leftIcon && (
          <motion.div
            ...
            className="absolute left-0.5 top-1/2 -translate-y-1/2 text-neutral-400 dark:text-neutral-500 [&_svg]:size-[10px]"
          >
        ...
        {rightIcon && (
          <motion.div
            ...
            transition={{ type: 'spring', bounce: 0 }}
            className="absolute right-0.5 top-1/2 -translate-y-1/2 text-neutral-500 dark:text-neutral-400 [&_svg]:size-[10px]"
          >
